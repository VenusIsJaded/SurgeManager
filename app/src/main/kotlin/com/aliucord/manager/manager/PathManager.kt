...
class PathManager(
    ...
    /**
     * The SurgeCord folder where shared SurgeCord files are stored.
     * Standard path: `~/SurgeCord`
     */
    val surgeDir = Environment.getExternalStorageDirectory().resolve("SurgeCord")
     ...
     */
    val keystoreFile = surgeDir.resolve("ks.keystore")
    ...
    fun cachedSurgeXposed(version: SemVer) = patchingDownloadDir
        .resolve("surgexposed")
        .resolve("$version.apk")
