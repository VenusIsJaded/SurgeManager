...
object Signer : KoinComponent {
    ...
    private fun createKey(): KeySet {
        ...
        // SHA256withRSA is required -- Android 9+ (and especially Samsung Android 14+/16)
        // explicitly reject APKs whose signing certificate was self-signed with SHA1withRSA,
        // returning STATUS_FAILURE_INCOMPATIBLE at install time.
