...
/**
 * Data stored inside patched APKs as ~~"aliucord.json"~~ "surge.json" in order to preserve install-time information about Aliucord and the Manager.
 */
@Serializable
data class InstallMetadata(
    ...
    /**
     * Version of SurgeXposed embedded into the APK.
     */
    val surgeXposedVersion: SemVer?,
)
