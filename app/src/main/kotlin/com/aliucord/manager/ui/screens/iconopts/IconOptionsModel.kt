...
class IconOptionsModel(
    ...
    init {
        when (prefilledOptions) {
            is IconReplacement.CustomColor if prefilledOptions.color == IconReplacement.SurgeColor -> {
                changeMode(IconOptionsMode.SurgeCord)
                initSelectedColor(IconReplacement.SurgeColor)
            }
    ...
    fun generateConfig(): IconReplacement? {
        return when (mode) {
            ...
            IconOptionsMode.SurgeCord -> IconReplacement.CustomColor(IconReplacement.SurgeColor)
