...
class PatchingScreen(private val data: PatchOptions) : Screen, Parcelable {
    ...
    override fun Content() {
        ...
        var expandedGroup by rememberSaveable { mutableStateOf<com.aliucord.manager.patcher.steps.StepGroup?>(com.aliucord.manager.patcher.steps.StepGroup.Prepare) }
        ...
        Scaffold(
            ...
            Column(
                ...
                LazyColumn(
                    ...
                    for ((group, steps) in model.steps?.entries ?: kotlinx.collections.immutable.persistentListOf()) {
