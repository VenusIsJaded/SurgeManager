    ...
    Scaffold(
        ...
        Column(
            ...
            RadioSelectorItem(
                ...
                description = stringResource(R.string.iconopts_variant_desc_rain),
                selected = mode == IconOptionsMode.SurgeCord,
                onClick = remember { { setMode(IconOptionsMode.SurgeCord) } },
            )
            RadioSelectorItem(
        ...
        Row(
            ...
            val drawable = if (mode == IconOptionsMode.CustomImage) {
                ...
                val color = when (mode) {
                    ...
                    IconOptionsMode.SurgeCord -> PatchOptions.IconReplacement.SurgeColor
