...
data class PatchOptions(
    ...
    sealed interface IconReplacement : Parcelable {
        ...
        companion object {
            ...
            /**
             * The default SurgeCord background color.
             */
            val SurgeColor = Color(0xFF2E2E2E)
    ...
    companion object {
        val Default = PatchOptions(
            appName = "SurgeCord",
            packageName = "dev.surgecord.app",
            debuggable = false,
            iconReplacement = IconReplacement.CustomColor(IconReplacement.SurgeColor),
            customVersionCode = "",
            isDevMode = false,
        )
    }
